...
const uint8_t RHID_ReportDescriptor[RHID_SIZ_REPORT_DESC] =
  {
	...
	0x85, 0x05,                    //   REPORT_ID (5) // пакет данных 62 байта (транспорт)
    0x09, 0x05,                    //   USAGE (Vendor Usage 5)
	0x75, 0x08,                    //   REPORT_SIZE (8)
    0x95, wMaxPacketSize-1,        //   REPORT_COUNT (63)
	0xb1, 0x82,                    //   FEATURE (Data,Var,Abs,Vol)

	0x85, 0x06,                    //   REPORT_ID (6) // репорт количества данных на прием, относительно ПК
    0x09, 0x05,                    //   USAGE (Vendor Usage 5)
	0x75, 0x08,                    //   REPORT_SIZE (8)
    0x95, 0x02,				       //   REPORT_COUNT (2)
	0xb1, 0x82,                    //   FEATURE (Data,Var,Abs,Vol)

    0xc0                           // END_COLLECTION					size = (3*2+2*44+1)= 89
}
