...
public:
    ...
    unsigned char buf[PacketSize+1], buf_in[PacketSize+1];
...
class req {
public:
    req(unsigned char idReport = 0, size_t pSize = 0, size_t payloadSize = 0): idR(idReport), pS(pSize), plS(payloadSize) { } //6, 3, 2
    ~req();
